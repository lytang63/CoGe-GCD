...
class CustomRadarDataset(Dataset):
    ...
    def _load_metadata(self):
        ...
        # 确定CSV文件路径
        if self.train:
            csv_path = os.path.join(self.root+'dataset/DC_comp/model_identification_split/', 'train.csv')
        else:
            csv_path = os.path.join(self.root+'dataset/DC_comp/model_identification_split/', 'test.csv')
