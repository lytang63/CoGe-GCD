...
from data.xh import get_radar_datasets as get_radar_datasets_xh
from data.gt import get_radar_datasets as get_radar_datasets_gt
...
from data.xh import subsample_classes as subsample_dataset_xh
from data.gt import subsample_classes as subsample_dataset_gt
...
sub_sample_class_funcs = {
    ...
    'xh': subsample_dataset_xh,
    'gt': subsample_dataset_gt,
...
get_dataset_funcs = {
    ...
    'xh': get_radar_datasets_xh,
    'gt': get_radar_datasets_gt,
...
def get_class_splits(args):
    ...
    if args.dataset_name == 'cifar10':
        ...
        args.unlabeled_classes = range(15, 30)
