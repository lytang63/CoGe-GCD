...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_composition', type=str2bool, default=False)
    ...
    args.save_dir = os.path.join(args.root_dir, f'{args.model_name}_{args.dataset}', 'compositional' if args.use_composition else 'baseline')
    if not args.silent:
        print(args)
        print('Loading model...')
    else:
    ...
    if args.model_name == 'vit_dino':
        ...
        args.interpolation = 3
        args.crop_pct = 0.875
        pretrain_path = os.environ.get('COGE_DINO_RESNET_PATH', 'pretrained_models/dino_resnet50_pretrain.pth')
