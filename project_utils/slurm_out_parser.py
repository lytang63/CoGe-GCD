...
save_root_dir = os.environ.get('COGE_SLURM_SUMMARY_DIR', 'outputs/slurm_summaries')
...
save_dir = os.environ.get('COGE_SLURM_SUMMARY_DIR', 'outputs/slurm_summaries')
base_path = os.environ.get('COGE_SLURM_LOG_PATTERN', 'outputs/slurm/myLog-{}.out')
